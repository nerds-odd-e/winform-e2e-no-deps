...
public class WinForm {
    ...
    @Value("${app.path:.\\winform-e2e-no-deps\\winform_ice\\软件系统客户端模版.exe}")
    ...
    public WiniumDriver createWinDriver() throws MalformedURLException {
    ...
    public WebDriver getWindowsDriver() throws MalformedURLException {
        if (windowsDriver == null)
